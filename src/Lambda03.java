...
public class Lambda03 {
    ...
    public static void harfSayisi7denAzKontrol(List<String> ikram) {
        System.out.printf(ikram.stream().allMatch(t -> t.length() <= 7) ? "List elemanları 7 ve daha az harften oluşuyor" : "List elemanları 7 harften fazla");
    }
    ...
    public static void wIleBaslayanElKontrol(List<String> ikram) {
        System.out.println(ikram.stream().noneMatch(t -> t.startsWith("w")) ? "w ile başlayan yemek is mimi olur" : "w ile başlayan yemek icat ettik");
    }
    ...
    public static void xIleBitenElKontrol(List<String> ikram) {
        System.out.println(ikram.stream().anyMatch(t -> t.endsWith("x")) ? "masaallah" : "x le yemek ismi biter mi hiç");
    }
